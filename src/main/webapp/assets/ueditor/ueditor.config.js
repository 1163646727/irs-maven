...
(function () {
     ...
     * window.UEDITOR_HOME_URL = "/Eshopping/ueditor/";
     */
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,textarea:'description' // 提交表单时，服务器获取编辑器提交内容的所用的参数，多实例时可以给容器name属性，会将name给定的值最为每个实例的键值，不用每次实例化的时候都设置这个值

        ,initialContent:'请在这里输入详情页内容!'    //初始化编辑器的内容,也可以通过textarea/script给值，看官网例子
